...
Ein egriff{Teich} ist ein solches sechsteiliges Spezialfeld. Seine gemeinsame
...
\section{Treibstoffverbrauch im Krieg}
Der Treibstoffverbrauch der Kriegseinheiten nach Bewegungsmenge ist noch nicht abschliessend einem Rohstoff zugeordnet.

\begin{itemize}
  \item Bei Panzern bestimmt die Bewegung vom Hauptbahnhof zum Kriegspunkt den Verbrauch.
  \item Bei Kriegsschiffen bestimmt die Bewegung vom naechsten Hafen zum Kriegspunkt den Verbrauch.
\end{itemize}

\offen{Treibstoffart und genaue Verbrauchsformel pro Bewegungsschritt festlegen.}
