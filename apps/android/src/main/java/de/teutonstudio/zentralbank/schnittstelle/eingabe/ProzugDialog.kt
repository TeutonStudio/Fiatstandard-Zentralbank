        ...
        text = {
            Column(
                ...
                Abschnitt("Automatischer Abbau") {
                    if (zustand.abbauErtraege.isEmpty()) {
                        Text("Noch keine Abbauerträge gutgeschrieben.")
                    }
                ...
                Abschnitt("Freiwillige Verarbeitung") {
                    ...
                    zustand.produktion.forEach { standort ->
                        ...
                        when {
                            ...
                            standort.versorgungFehlt ->
                                Text("Nicht verwendbar: Verwaltungsstandort nicht versorgt")
