...
data class VerwaltungsVerpflichtung(
    ...
    /** Rohstoffe, die nach Verrechnung der Eigenproduktion noch vom Spieler kommen müssen. */
    val bedarf: Map<Rohstoff, Int>,
    /** Anteil des Standortertrags, der unmittelbar dessen eigenen Bedarf deckt. */
    val eigenversorgung: Map<Rohstoff, Int> = emptyMap(),
    /** Nach Eigenversorgung verbleibender Ertrag, der erst bei Versorgung gutgeschrieben wird. */
    val auszahlbarerErtrag: Map<Rohstoff, Int> = emptyMap(),
)
